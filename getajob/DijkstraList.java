//Dijkstra using adjacency list with min heap. Also, prints the path.
...
public class DijkstraList {
    ...
    public static class Graph {
        ...
        public void findShortestPaths(int sourceName){
            applyDijkstraAlgorith(vertices[sourceName]);
        ...
        public void applyDijkstraAlgorith(Vertex src) {
